...
helpers.toast = function(message) {
  ...
  function loadInlineAdministration() {
    ...
    const script = document.createElement("script");
    script.src = "inline-admin.js?v=10.31-home-stack-simple";
  ...
  function refreshStylesheetVersion() {
    document.querySelectorAll('link[rel="stylesheet"]').forEach(link => {
      ...
      const versioned = `${base}?v=10.31-home-stack-simple`;
  ...
  function loadClaudeStudio() {
    ...
    if (!document.getElementById(cssId)) {
      ...
      link.id = cssId;
      link.rel = "stylesheet";
      link.href = "claude-design.css?v=10.31-home-stack-simple";
    ...
    if (!document.getElementById(scriptId)) {
      const script = document.createElement("script");
      script.id = scriptId;
      script.src = "claude-design.js?v=10.31-home-stack-simple";
      script.defer = true;
